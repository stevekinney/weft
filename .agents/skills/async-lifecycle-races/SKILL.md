...
12. For workflow services, treat resolver success, unavailable results, throws, scheduled occurrences, terminal commit faults, delayed-start timers, terminal cleanup, purge, and retention as distinct lifecycle outcomes.
