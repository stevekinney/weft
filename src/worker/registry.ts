...
export class WorkerRegistry {
  ...
  #pickRoundRobin(eligible: WorkerInfo[], queue: string | undefined, activityName: string): WorkerInfo {
  ...
  getDeploymentSummaries(_now: number): WorkerDeploymentSummary[] {
    ...
    return projectDeploymentSummaries(snapshots, (name) =>
      this.#deploymentDrainStates.has(name),
    );
  }
