...
- Long-poll and WebSocket completion authorization must reject missing or mismatched echoes when the stored in-flight record has an `attemptToken`, while still allowing token-less records through the worker ownership guard.
