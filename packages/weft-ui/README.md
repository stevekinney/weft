...
| Dynamic-source load diagnostics (`weft.catalog.diagnostics`) — the Registry → Dynamic workflow sources panel and each installed revision's load state (WFT-116)                                                                                                  | `scoped` — `system:read`                                                                                                                             |
