 ...
 * @example
 * ```ts
 * import { type AuthAuditEvent } from '@lostgradient/weft';
 *
 ...
 * @example
 * ```ts
 * import { type AuthAuditEvent, type AuthAuditSink } from '@lostgradient/weft';
 *
 ...
 * @example
 * ```ts
 * import { defaultAuthAuditSink } from '@lostgradient/weft';
 *
