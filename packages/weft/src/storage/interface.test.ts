...
describe('KEYS insertion order', () => {
  it('matches the pre-split Object.keys(KEYS) sequence exactly', () => {
    // KEYS is assembled in interface.ts from several per-domain key modules
    // (see workflow-record-keys.ts, workflow-lifecycle-keys.ts, signal-keys.ts,
    // lease-keys.ts, mailbox-keys.ts, outbox-keys.ts, ownership-keys.ts, and
    // catalog-keys.ts). Before that split, KEYS was one large object literal
    // declared directly in interface.ts, and some consumers enumerate
    // `Object.keys(KEYS)`. This test pins the exact original insertion order so
    // that order can never silently regress across a future refactor of these
    // modules.
    expect(Object.keys(KEYS)).toEqual([
      ...
      'scheduleRun',
      'scheduleRunLink',
      'scheduleRunBySchedulePrefix',
      'scheduleRunBySchedule',
      'operation',
      'operationInflight',
      'operationQueued',
      'operationResolved',
      'bulkOperationAuditPrefix',
      'bulkOperationAudit',
      'operationResolvedByTimePrefix',
      'operationResolvedByTime',
      'asyncActivity',
      ...
      'fleetEventTail',
      'fleetEventWatermark',
      'fleetEventByWorkflowPrefix',
      'fleetEventByWorkflow',
      'signal',
      'startSignal',
      'signalSequence',
      'signalAcceptedResponsePrefix',
      'signalAcceptedResponse',
      'deadline',
      'terminalCleanup',
      'teardownTimer',
      'delayedStart',
      'terminalWorkflowPrefix',
      'terminalWorkflow',
      'attribute',
      'attributeIndex',
      'tagIndex',
      ...
      'leaseHolder',
      'applicationMailbox',
      'applicationMailboxSinkProbe',
      'applicationCommandPrefix',
      'applicationCommand',
      'applicationCommandReadyPrefix',
      'applicationCommandReady',
      'applicationCommandIdempotency',
      'applicationCommandBySequencePrefix',
      'applicationCommandBySequence',
      'applicationCommandTerminalPrefix',
      'applicationCommandTerminal',
      'applicationOutbox',
      'applicationOutboxSinkProbe',
      'applicationDeliveryPrefix',
      'applicationDelivery',
      'applicationDeliveryDuePrefix',
      'applicationDeliveryDue',
      'applicationDeliveryIdempotency',
      'applicationDeliveryBySequencePrefix',
      'applicationDeliveryBySequence',
      'applicationDeliveryTerminalPrefix',
      ...
      'review',
      'workflowHeaders',
      'childCancellationPrefix',
      'childCancellation',
      'childWorkflowByParentPrefix',
      'childWorkflowByParent',
      'terminalCleanupNeeded',
      'workflowConcurrency',
      'workflowConcurrencyHolder',
      'workflowHasServices',
      'finalizerState',
      'teardownOwed',
      'teardownSucceeded',
      'teardownDeadLetter',
      'teardownDeadLetterPrefix',
      'teardownDeadLetterHistory',
      'teardownDeadLetterHistoryPrefix',
      'offload',
      'archive',
      'stateExecution',
      'stateWorkflow',
      ...
      'budgetCharged',
      'toolEffect',
      'workflowVisibilityStatus',
      'workflowVisibilityType',
      'workflowVisibilityCreated',
      'workflowVisibilityUpdated',
      'workflowVisibilityDeadline',
      'workflowVisibilityManifest',
      'workflowVisibilityMetaVersion',
      'workflowVisibilityMetaBuiltAt',
      'workflowVisibilityMetaCursor',
    ]);
  });
});
