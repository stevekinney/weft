 ...
 * @example
 * ```ts
 * import type { MetricType } from '@lostgradient/weft';
 *
 ...
 * @example
 * ```ts
 * import { METRICS, type MetricDefinition } from '@lostgradient/weft';
 *
 ...
 * @example
 * ```ts
 * import type { CounterMetric } from '@lostgradient/weft';
 *
 ...
 * @example
 * ```ts
 * import type { HistogramMetric } from '@lostgradient/weft';
 *
 ...
 * @example
 * ```ts
 * import type { GaugeMetric } from '@lostgradient/weft';
 *
 ...
 * @example
 * ```ts
 * import { MetricsCollector, type MetricsSnapshot } from '@lostgradient/weft';
 *
