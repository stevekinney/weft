 ...
 *
 * Every "restart" here is a fresh `Mailbox` over the same storage —
...
describe('Mailbox FIFO order through expiry and retry', () => {
...
describe('Mailbox dead-lettering', () => {
...
describe('Mailbox terminal retention', () => {
...
describe('Mailbox recovery across storage backends', () => {
