 ...
 *
 * @module core/mailbox.test-support
 */
...
export function createMailboxFixture(
  overrides: Partial<MailboxOptions> & { readonly clock?: MailboxClock } = {},
): MailboxFixture {
...
/** Every fleet event an {@link MailboxEventSink} was asked to append. */
 ...
 */
export class RecordingEventSink implements MailboxEventSink {
