...
import { decodeApplicationCommandRecord, encodeApplicationCommandRecord } from './mailbox-codec.ts';
...
export function emptyMailboxRecord(namespace: string, resourceId: string): MailboxRecord {
  return {
...
export function headerOperation(keys: MailboxKeys, record: MailboxRecord): BatchOperation {
