...
import { commitOutboxTransition, loadDelivery, planDeliveryTransition } from './outbox-storage.ts';
import {
...
async function fenced(
  ...
  decide: (
    record: ApplicationDeliveryRecord,
    now: number,
  ) => OutboxTransition<ApplicationDeliveryRecord>,
