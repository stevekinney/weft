...
export function emptyOutboxRecord(namespace: string, ownerId: string): OutboxRecord {
  return {
...
export function headerOperation(keys: OutboxKeys, record: OutboxRecord): BatchOperation {
