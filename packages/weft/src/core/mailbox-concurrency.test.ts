...
describe('Mailbox concurrent claims', () => {
...
describe('Mailbox attempt fencing', () => {
...
describe('Mailbox concurrent admission', () => {
...
describe('Mailbox state and event atomicity', () => {
...
describe('Mailbox concurrency across storage backends', () => {
