...
import {
  ...
  type MailboxTransitionRejection,
...
import { requireDerivedInstant, type ValidatedCommandInput } from './mailbox-validation.ts';
...
export function releaseWaitingCommand(
  ...
  now: number,
): MailboxTransition<ApplicationCommandAvailable> {
