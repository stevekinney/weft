 ...
 *
 * @module core/application-outbox-internals
 */
...
import type { ResolvedOutboxPolicy } from './application-outbox-validation.ts';
 ...
 * @example
 * ```ts
 * import { ApplicationOutboxContentionError } from '@lostgradient/weft';
 *
 * const error = new ApplicationOutboxContentionError('enqueue', null);
 * console.log(error.code); // 'ApplicationOutboxContentionError'
 * ```
 */
export class ApplicationOutboxContentionError extends WeftError<'ApplicationOutboxContentionError'> {
