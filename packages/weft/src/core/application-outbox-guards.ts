 ...
 *
 * @module core/application-outbox-guards
 */
...
export const MAX_APPLICATION_OUTBOX_BACKLOG = 1_000_000;

/** Ceiling on a `list()` limit. */
export const MAX_APPLICATION_OUTBOX_LIST_LIMIT = 1000;
...
export function clampListLimit(limit: number | undefined): number {
  ...
  return Math.min(limit, MAX_APPLICATION_OUTBOX_LIST_LIMIT);
}
