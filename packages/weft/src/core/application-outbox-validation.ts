 ...
 * trace.
 *
 * @module core/application-outbox-validation
 */
...
import {
  ...
  MAX_APPLICATION_OUTBOX_BACKLOG,
 ...
 */
export function resolveOutboxPolicy(options: ApplicationOutboxOptions): ResolvedOutboxPolicy {
...
function resolveBounds(options: ApplicationOutboxOptions) {
  return {
    maxBacklog: positive(options.maxBacklog, 1000, 'maxBacklog', MAX_APPLICATION_OUTBOX_BACKLOG),
