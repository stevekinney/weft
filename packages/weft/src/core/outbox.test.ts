...
describe('Outbox construction', () => {
  it('rejects storage without conditional batches, snapshot scans, or linearizable reads', () => {
    ...
    for (const storage of [
      ...
      expect(() => new Outbox({ storage, namespace: 'n', ownerId: 'o' })).toThrow(
...
describe('Outbox receipts and listing', () => {
...
describe('Outbox adapter runner', () => {
...
describe('Outbox fenced claim API', () => {
...
describe('Outbox operator transitions', () => {
...
describe('Outbox events and secrets', () => {
