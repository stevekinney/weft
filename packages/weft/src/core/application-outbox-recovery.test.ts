 ...
 *
 * A "restart" is modelled as a new `ApplicationOutbox` over the same storage
...
describe('ApplicationOutbox restart', () => {
...
describe('ApplicationOutbox maintenance scan', () => {
...
describe('ApplicationOutbox retention', () => {
