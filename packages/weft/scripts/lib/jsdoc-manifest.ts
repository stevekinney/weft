...
const PROSE_ONLY_NAME_PATTERN =
  /^(ActivityCompletedInterception|ActivityFailedInterception|AlertAction|AlertStateSnapshot|AnnotateResult|BatchOperation|BudgetState|BulkCancelResult|BulkDeleteResult|BulkOperationError|BulkSignalResult|BulkTagResult|CheckpointState|CheckpointSummary|ChildWorkflowOptions|ConditionalBatchCondition|ConstraintCheckState|ConstraintViolation|CoordinatedUpdateResult|DatabaseHealth|DiagnosticReport|FieldDiff|ForkLineage|HealthStatus|InvocationResult|JSONValue|KnownWorkflowName|LargestCheckpoint|LongestRunningWorkflow|MemoryProfile|MemorySample|MessagePackValue|NormalizedRetentionPolicy|PaginatedResult|PostgresPool|PostgresPoolClient|PrometheusExporter|PruneCheckpointsResult|PurgeResult|QueueStatistics|Recommendation|RecommendationSeverity|ReviewDecision|ReviewDecisionRecord|RoutingPolicy|RuntimeKind|ScheduleAccessOptions|ScheduleFilter|ScheduleState|ScheduleStatus|ScheduleSummary|SchedulingPolicy|SerializedBudgetState|ShapeDescriptor|ShapeDiffOptions|StabilityResult|StorageSizeReport|StorageValueParser|StoredStreamChunk|TenantQuotaMetricUsage|TenantQuotaUsage|TenantWorkflowCreationRateUsage|UnknownNameWhenRegistryEmpty|UpdateResult|VersionCheckReport|WorkflowEvent|WorkflowReplay|WorkflowSessionState|WorkflowState|WorkflowStatistics|WorkflowStatus|WorkflowStatusCounts|WorkflowSummary|WorkflowTimelineEntry|WorkflowTimelineStatus|WorkflowTypeReport)$/;
