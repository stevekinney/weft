...
| `WorkflowTimeoutError`                      | `WorkflowTimeoutError`                      | A workflow exceeds its execution or run timeout.                                                                          | Terminal workflow failure                                                    |
...
| `StartOrSignalConflictError`                | `StartOrSignalConflictError`                | `engine.startOrSignal()` targets a terminal workflow, which cannot accept the signal and is not replaced.                 | Catchable conflict                                                           |
